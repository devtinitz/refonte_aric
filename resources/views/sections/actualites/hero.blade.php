<!-- Header Section -->
<header id="actualites-section-hero" data-cms-section="hero" class="relative pt-32 pb-20 flex flex-col justify-center items-start overflow-hidden bg-tech-navy group/section">
    <!-- Section Controls -->
    @if(auth()->check())
    ...
    <x-cms-editable key="actualites_hero_bg" type="media" buttonClass="top-24 left-10" positionClass="absolute" class="inset-0 w-full h-full">
        <div class="absolute inset-0 bg-tech-navy"></div>
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col justify-start items-start text-left">
        <div data-aos="fade-up" class="text-left">
            <div class="text-tech-cyan font-bold text-xs uppercase tracking-[0.3em] mb-4">
                <x-cms-editable key="news_hero_badge">Insights & News</x-cms-editable>
            </div>
            <h1 class="text-4xl md:text-6xl font-black text-white mb-8">
                <x-cms-editable key="news_hero_title">
                    L'Actualité du <span class="text-gradient-light">Groupe</span>.
                </x-cms-editable>
            </h1>
