...
<header id="expertise-section-hero" data-cms-section="hero" class="relative min-h-[60vh] md:min-h-[50vh] flex flex-col justify-center items-start overflow-hidden text-white group/section">
    <!-- Section Controls -->
    @if(auth()->check())
    ...
    <x-cms-editable key="expertise_hero_video" type="media" buttonClass="top-24 left-10" positionClass="absolute" class="absolute inset-0 w-full h-full">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10 w-full pt-10 flex flex-col justify-start items-start text-left">
        <div data-aos="fade-up" class="text-left">
            <div class="text-tech-cyan font-bold text-xs uppercase tracking-[0.3em] mb-4">Pôles Technologiques</div>
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6">
                <x-cms-editable key="expertise_hero_title">
                    Notre <span class="text-gradient-light">Expertise</span> & Solutions.
            </h1>
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-[0]">
        <svg class="relative block w-[calc(100%+1.3px)] h-[60px] md:h-[100px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
